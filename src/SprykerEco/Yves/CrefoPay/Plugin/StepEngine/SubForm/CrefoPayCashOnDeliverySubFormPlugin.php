 ...
 */
class CrefoPayCashOnDeliverySubFormPlugin extends AbstractPlugin implements SubFormPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFactory()->createCashOnDeliveryForm();
    }
    ...
    {
        return $this->getFactory()->createCashOnDeliveryFormDataProvider();
    }
}
